...
describe(`/ReferencedPaymentNonexistence/verifyFDC (${getTestFile(__filename)})`, () => {
  baseHooks();
  ...
  it.skip('should get status', async () => {
    const payload = {
      abiEncodedRequest:
  ...
  // TODO: skipped pending fixture re-dump — state.last_indexed_block_number < MAX(blocks.block_number) trips the DATA_AVAILABILITY_FAILURE guard in IIndexedQueryManager.getReferencedTransactions
  it.skip('should get abiEncodedResponse without 0x in abiEncodedRequest', async () => {
    const payload = {
      abiEncodedRequest:
  ...
  // TODO: skipped pending fixture re-dump — state.last_indexed_block_number < MAX(blocks.block_number) trips the DATA_AVAILABILITY_FAILURE guard in IIndexedQueryManager.getReferencedTransactions
  it.skip('should get abiEncodedResponse with 0X in abiEncodedRequest', async () => {
    const payload = {
      abiEncodedRequest:
        '',
    };
