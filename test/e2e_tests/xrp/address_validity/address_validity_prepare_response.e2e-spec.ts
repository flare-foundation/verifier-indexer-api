...
describe(`/AddressValidity/prepareResponse (${getTestFile(__filename)})`, () => {
  baseHooks();
  it('should get abiEncodedRequest', async () => {
    ...
    expect(resp.requestBody.addressStr).to.be.equal(
      'rH6XNmqWJacqw1cYwxrVqhiMcQrwV2LX1f',
    );
    ...
    expect(resp.responseBody.standardAddressHash).to.be.equal(
      '0xb841508f07d80700259b0c50c33b20308c28a7777c837ec30f9ea645a4a6f833',
    );
  });
  ...
  it('should get bad request (400) with too long sourceId', async () => {
    const payload = {
      attestationType:
        '0x4164647265737356616c69646974790000000000000000000000000000000000',
      sourceId:
        '0x74657374585250000000000000000000000000000000000000000000000000002',
      requestBody: {
        addressStr: 'rH6XNmqWJacqw1cYwxrVqhiMcQrwV2LX1f',
      },
    };
  ...
  it('should get bad request (400) with too short sourceId', async () => {
    const payload = {
      attestationType:
        '0x4164647265737356616c69646974790000000000000000000000000000000000',
      sourceId:
        '0x746573745852500000000000000000000000000000000000000000000000000',
      requestBody: {
        addressStr: 'rH6XNmqWJacqw1cYwxrVqhiMcQrwV2LX1f',
      },
    };
  ...
  it('should get bad request (400) with wrong sourceId (but with hexadecimal characters)', async () => {
    const payload = {
      attestationType:
        '0x4164647265737356616c69646974790000000000000000000000000000000000',
      sourceId:
        '0x46573745852500000000000000000000000000000000000000000000000000a',
      requestBody: {
        addressStr: 'rH6XNmqWJacqw1cYwxrVqhiMcQrwV2LX1f',
      },
    };
