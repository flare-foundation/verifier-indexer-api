...
describe(`/ConfirmedBlockHeightExists/prepareRequest (${getTestFile(__filename)})`, () => {
  baseHooks();
  ...
  it('should get 400 with too long sourceId', async () => {
    const payload = {
      attestationType:
        '0x436f6e6669726d6564426c6f636b486569676874457869737473000000000000',
      sourceId:
        '0x74657374585250000000000000000000000000000000000000000000000000000',
      requestBody: {
        blockNumber: '2882191',
        queryWindow: '1',
      },
  ...
  it('should get 400 with no hexadecimal characters in sourceId', async () => {
    const payload = {
      attestationType:
        '0x436f6e6669726d6564426c6f636b486569676874457869737473000000000000',
      sourceId:
        '0x746573745852500000000000000000000000000000000000000000000000000y',
      requestBody: {
        blockNumber: '2882191',
        queryWindow: '1',
      },
