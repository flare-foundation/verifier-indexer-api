...
describe(`/BalanceDecreasingTransaction/prepareResponse (${getTestFile(__filename)})`, () => {
  baseHooks();
  it('should get valid status', async () => {
    ...
    expect(res.requestBody.sourceAddressIndicator).to.be.equal(
      standardAddressHash('nZBR99PMzrSPNp8uiToQw9QZpg76SUyeG6'),
    );
    ...
    expect(res.responseBody.standardPaymentReference).to.be.equal(
      '0x46425052664100010000000000000000000000000000000000000000001c1e87',
    );
  });
  ...
  it('should get invalid status with valid transaction, but not in DB', async () => {
    const payload = {
      ...
      requestBody: {
        transactionId:
          'c7b351b086f3b76d7eb46fe042c6e8484a774618420fa0e7ae36e7237c9961d2',
        sourceAddressIndicator: standardAddressHash(
  ...
  it('should get 400 with too short transactionId', async () => {
    const payload = {
      ...
      requestBody: {
        transactionId:
          'b93aefcbdf102891e81620632e3e3312130d36298569619386f5f40693940b7',
        sourceAddressIndicator: standardAddressHash(
          'nZBR99PMzrSPNp8uiToQw9QZpg76SUyeG6',
        ),
      },
  ...
  it('should get 400 with too long transactionId', async () => {
    const payload = {
      ...
      requestBody: {
        transactionId:
          'b93aefcbdf102891e81620632e3e3312130d36298569619386f5f40693940b741',
        sourceAddressIndicator: standardAddressHash(
          'nZBR99PMzrSPNp8uiToQw9QZpg76SUyeG6',
        ),
      },
  ...
  it('should get 400 with not hexadecimal characters in transactionId', async () => {
    const payload = {
      ...
      requestBody: {
        transactionId:
          'b93aefcbdf102891e81620632e3e3312130d36298569619386f5f40693940b7y',
        sourceAddressIndicator: standardAddressHash(
          'nZBR99PMzrSPNp8uiToQw9QZpg76SUyeG6',
        ),
      },
