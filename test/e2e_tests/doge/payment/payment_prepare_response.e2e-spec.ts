...
describe('/Payment/prepareResponse', () => {
  it('should get abiEncodedRequest', async () => {
    ...
    ).to.be.equal(standardAddressHash('neRSiUUeJr8EB9jKmdG9MPycfFawSy2Nwy'));
    expect(
  ...
  it('should get bad request (400) for too long transactionId', async () => {
    const payload = {
      ...
      requestBody: {
        transactionId:
          'b93aefcbdf102891e81620632e3e3312130d36298569619386f5f40693940b740',
        inUtxo: '0',
        utxo: '0',
      },
    };
