...
describe("/ConfirmedBlockHeightExists/prepareResponse", () => {
    it("should get status", async () => {
        ...
        expect(response.body.response.requestBody.blockNumber).to.be.equal('3490156');
    ...
    it("should get VALID status with queryWindow=0", async () => {
        ...
        expect(response.body.response.responseBody.blockTimestamp).to.be.equal('1732779898');
        expect(response.body.response.responseBody.numberOfConfirmations).to.be.equal('6');
        expect(response.body.response.responseBody.lowestQueryWindowBlockNumber).to.be.equal('3490155');
        expect(response.body.response.responseBody.lowestQueryWindowBlockTimestamp).to.be.equal('1732779897');
    });
