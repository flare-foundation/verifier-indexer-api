...
describe("/BalanceDecreasingTransaction/mic", () => {
    ...
    it("should get invalid status with valid transaction, but not in DB", async () => {
        const payload = {
            ...
            sourceId: "0x74657374444f4745000000000000000000000000000000000000000000000000",
            requestBody: {
                transactionId: "c7b087f35ceb044f7283b232e634d1cafd331f65a09beb92065f9182055e6dbf",
                sourceAddressIndicator: standardAddressHash("nhm2mfWa9Z6rXzYWZPgkKEgiiyguj8NXd5")
            }
        }
        const response = await request(app.getHttpServer())
            .post("/BalanceDecreasingTransaction/mic")
