import { ChainType, MCC, MccCreate, UtxoMccCreate } from '@flarenetwork/mcc';
...
export class DOGEConfirmedBlockHeightExistsVerifierService {
  ...
  async verifyRequestInternal(
    ...
    if (
      request.attestationType !==
        encodeAttestationName('ConfirmedBlockHeightExists') ||
      request.sourceId !==
        encodeAttestationName(
  ...
  public async verifyEncodedRequest(
    ...
    const requestJSON =
      this.store.parseRequest<ConfirmedBlockHeightExists_Request>(
        abiEncodedRequest,
      );
  ...
  public async prepareResponse(
    request: ConfirmedBlockHeightExists_RequestNoMic,
  ): Promise<AttestationResponseDTO_ConfirmedBlockHeightExists_Response> {
  ...
  public async mic(
    ...
    return new MicResponse({
      ...
      messageIntegrityCode:
        this.store.attestationResponseHash<ConfirmedBlockHeightExists_Response>(
          response,
          MIC_SALT,
        ),
    });
