...
export class DOGEReferencedPaymentNonexistenceVerifierService {
  ...
  async verifyRequestInternal(
    ...
    if (
      request.attestationType !==
        encodeAttestationName('ReferencedPaymentNonexistence') ||
      request.sourceId !==
        encodeAttestationName(
  ...
  public async verifyEncodedRequest(
    ...
    const requestJSON =
      this.store.parseRequest<ReferencedPaymentNonexistence_Request>(
        abiEncodedRequest,
      );
  ...
  public async prepareResponse(
    request: ReferencedPaymentNonexistence_RequestNoMic,
  ): Promise<AttestationResponseDTO_ReferencedPaymentNonexistence_Response> {
  ...
  public async mic(
    ...
    return new MicResponse({
      ...
      messageIntegrityCode:
        this.store.attestationResponseHash<ReferencedPaymentNonexistence_Response>(
          response,
          MIC_SALT,
        ),
    });
