...
export abstract class IIndexedQueryManager {
   ...
   * boundary range.
   */
  public abstract queryTransactions(
   ...
   * query parameters.
   */
  public async getConfirmedBlock(
    params: ConfirmedBlockQueryRequest,
  ): Promise<ConfirmedBlockQueryResponse> {
  ...
  public async getConfirmedTransaction(
    params: ConfirmedTransactionQueryRequest,
  ...
  public async getReferencedTransactions(
    ...
    const firstOverflowBlock = await this.getFirstConfirmedOverflowBlock(
      params.deadlineBlockTimestamp,
      params.deadlineBlockNumber,
    );
    ...
    const transactionsQueryResult = await this.queryTransactions({
      ...
      onlyRelevantStatus: params.onlyRelevantStatus,
    });
   ...
   */
  public abstract getLastConfirmedBlockStrictlyBeforeTime(
    timestamp: number,
  ): Promise<BlockResult | undefined>;
   ...
   */
  protected abstract getFirstConfirmedOverflowBlock(
    timestamp: number,
    blockNumber: number,
  ): Promise<BlockResult | undefined>;
