...
export enum AttestationResponseStatus {
  ...
  // web/jq
  INVALID_SOURCE_URL = 'INVALID: INVALID SOURCE URL',
  INVALID_HTTP_METHOD = 'INVALID: INVALID OR NOT ALLOWED HTTP METHOD',
  INVALID_HEADERS = 'INVALID: INVALID HEADERS',
  INVALID_QUERY_PARAMS = 'INVALID: INVALID QUERY PARAMETERS',
  INVALID_BODY = 'INVALID: INVALID BODY',
  INVALID_JQ_FILTER = 'INVALID: INVALID JQ FILTER',
  INVALID_ABI_SIGNATURE = 'INVALID: INVALID ABI SIGNATURE',
  INVALID_RESPONSE_CONTENT_TYPE = 'INVALID: INVALID RESPONSE CONTENT TYPE',
  INVALID_RESPONSE_JSON = 'INVALID: INVALID JSON RESPONSE',
  INVALID_JQ_PARSE_ERROR = 'INVALID: JQ PARSE ERROR',
  INVALID_DATA_AVAILABILITY_ISSUE = 'INVALID: DATA AVAILABILITY ISSUE',
  INVALID_FETCH_ERROR = 'INVALID: FETCH ERROR',
  INVALID_ENCODE_ERROR = 'INVALID: ABI ENCODING ERROR',
  PROCESSING_TIMEOUT = 'INVALID: PROCESSING TIMEOUT',
  PROCESSING_ERROR = 'INVALID: PROCESSING ERROR',
